...
import './settings.css';
const Settings = ({ presetChanged, presets, settings, onChange, onImport, importCount, onLoadCustomPreset, activeSource, activePresetName, isPresetDirty, onRevertBuiltin, onRevertUser, midi, instruments, keysRef, onVolumeChange }) => (
