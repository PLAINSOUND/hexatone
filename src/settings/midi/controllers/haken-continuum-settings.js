...
const HakenContinuumSettings = ({
  ...
  return (
    <>
      ...
      <label title="Shapes post-snap Continuum X bending around the selected scale note. 0 is linear. The full slider travel maps to an effective shaping span of 0–8, giving subtler control near the playable range.">
        X Glide Shaping
        <span
          class="sidebar-input"
          style={{
