...
export const SETTINGS_REGISTRY = [
  ...
  {
    key: "linnstrument_pitch_bend_mode",
    tier: "local",
    type: "string",
    default: "off",
    perController: true,
    description: "LinnStrument User Firmware pitch bend mode: off or scale-aware row glide",
  },
  {
    key: "linnstrument_pitch_bend_shape",
    tier: "local",
    type: "int",
    default: 60,
    perController: true,
    description: "LinnStrument User Firmware row-glide shaping (linear to near-stepped)",
  },
  {
    key: "linnstrument_x_spike_reduction",
    tier: "local",
    type: "int",
    default: 25,
    perController: true,
  ...
  },
  {
    ...
    default: 80,
    perController: true,
    description: "LinnStrument User Firmware X-input smoothing strength (0 = off, 100 = strongest)",
  },
  {
    key: "linnstrument_channel_allocation",
    tier: "local",
    type: "string",
  ...
  { key: "osc_quick_release_raster_only", tier: "local", type: "bool", default: false, perController: false },
