/**
 * src/hooks/use-import.js
 *
 * App-level import hook for Scala/Ableton scale text.
 *
 * It owns the "scale_import" workflow: parse imported text, derive reasonable
 * initial labels/colours/layout hints, and merge the result back into the live
 * settings object while keeping the app ready/render state in sync.
 */
