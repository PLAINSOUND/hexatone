...
Version 3.1.0_beta : (current) refactoring code to automatically map isomorphic controllers, changed octave-to-equave to allow user specified behaviour for other scales; fixes to TuneCell and various bugfixes
